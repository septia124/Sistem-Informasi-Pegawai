...
<div class="container-fluid">
  ...
  <div class="table-responsive">
                ...
                <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;" width="100%" cellspacing="0"> 
                  ...
                  <tbody>
                  <?php $__currentLoopData = $jbts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr role="row" class="odd">
                  <td><?php echo e($d->kode_jbts); ?></td>
                  <td><?php echo e($d->nama_jabatan); ?></td>
                  <td>
                    <!-- Button trigger modal -->
                    <!-- Button trigger modal -->
                    <a href="/pegawai/tmjabatans/hapus/<?php echo e($d->kode_jbts); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
...
<?php echo $__env->make('layouts.induk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Simpeg\resources\views/tm/jabatans.blade.php ENDPATH**/ ?>